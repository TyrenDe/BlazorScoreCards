...
{
    private const string ScoresKey = "sevenwonders_scores";
    ...
    [EffectMethod]
    public async Task EffectSevenWondersGameState(LoadInitialStateAction action, IDispatcher dispatcher)
    {
    ...
    [EffectMethod]
    public async Task EffectSevenWondersGameState(UpdateScoreAction action, IDispatcher dispatcher)
    {
        var scores = await LoadScoresAsync();
    ...
    [EffectMethod]
    public async Task EffectSevenWondersGameState(ResetScoresAction action, IDispatcher dispatcher)
    {
